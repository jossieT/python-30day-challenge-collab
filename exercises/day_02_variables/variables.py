...
print(len_first == len_last)
# Declare two variables num_one and num_two 
num_one, num_two = 5, 4 
# Add num_one and num_two and assign the result to a variable total
total = num_one + num_two
# Subtract num_two from num_one and assign the result to a variable diff 
...
exp = num_one**num_two 
# Use floor division to find num_one divided by num_two and assign the value to a variable floor_division
