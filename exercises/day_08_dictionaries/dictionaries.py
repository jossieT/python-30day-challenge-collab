...
student = {'first':'John', 'last_name':'Zekarias', 'gender':'male', 'age':24, 'martial': 'single',
            'skills': ['Python', 'C++', 'HTML', 'CSS', 'IoT', 'Raspberry Pi'], 
            'country': 'Ethiopia', 'city':'Addis Ababa', 'address': 'King George VI Street'
            }
